...
var VALUE_CASES = [
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 603.49, netAnnual: 8998.76
  },
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 450.54, netAnnual: 8846.54
  },
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 795.00, netAnnual: 14115.50
  },
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 720.04, netAnnual: 15186.11
  },
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 784.60, netAnnual: 16141.82
  },
  {
    ...
    wedgeType: 'exempt', wedgeAmount: 960.00, netAnnual: 18738.70
  },
  {
    ...
    wedgeType: 'deduction', wedgeAmount: 1000.00, netAnnual: 18779.39
  },
  {
    ...
    wedgeType: 'deduction', wedgeAmount: 1000.00, netAnnual: 20766.36
  },
  {
    ...
    wedgeType: 'deduction', wedgeAmount: 1000.00, netAnnual: 20583.60
  },
  {
    ...
    wedgeType: 'deduction', wedgeAmount: 1000.00,
  ...
  },
  {
    ...
    wedgeType: 'deduction', wedgeAmount: 913.55, netAnnual: 26452.39
  },
  {
    ...
    wedgeType: 'none', wedgeAmount: 0.00, netAnnual: 37554.66
  },
  {
    ...
    wedgeType: 'none', wedgeAmount: 0.00, netAnnual: 72225.98
  }
];
...
var runTests = function runTests(engine, t) {
  ...
  BREAKPOINT_CASES.forEach(function (expected) {
    var found = breakpoints.filter(function (bp) {
      return bp.space === expected.space && Math.abs(bp.threshold - expected.threshold) < 1e-9;
    })[0];
  ...
  var upRal = engine.grossFromTaxable(15000);
  ...
  t.ok('il gradino a imponibile 15.000 fa salire il netto', overGap > underGap,

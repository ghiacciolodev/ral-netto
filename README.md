...
Caso modellato: **impiegato, tempo indeterminato, full time, 365 giorni lavorati,
residente a Milano (Lombardia), nessun familiare a carico, nessuna agevolazione,
nessun onere deducibile o detraibile.** Fuori da questo caso il modello non è valido;
...
5. **Riduzione del cuneo fiscale**: somma esente sotto i 20.000 di reddito, oppure ulteriore detrazione fra 20.000 e 40.000. Le due misure sono alternative, mai cumulabili.
6. **IRPEF netta** = max(0, lorda meno detrazioni). L'eccedenza per incapienza si perde e non è rimborsabile.
7. **Addizionali**: regionale Lombardia a scaglioni, comunale Milano ad aliquota unica con soglia di esenzione. Entrambe sull'imponibile, non ridotte dalle detrazioni.
8. **Netto** = RAL meno contributi meno IRPEF netta meno addizionali più la somma esente del cuneo.
...
| Full time, 365 giorni lavorati | Il ragguaglio ai giorni delle detrazioni non si attiva mai. |
...
| Minimo garantito della detrazione (690 € a tempo indeterminato, 1.380 € a determinato) non implementato | Con 365 giorni lavorati non si attiva mai, perché la detrazione piena vale 1.955 €. |
...
| TFR | RAL / 13,5 meno 0,50% al Fondo di garanzia | [art. 2120 codice civile](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:regio.decreto:1942-03-16;262) |
| Costo azienda | 29,4% datore, INAIL 0,5% | Nessuna fonte primaria: sono medie di categoria |

**Una citazione non è chiusa.** L'aliquota IVS del 9,19% a carico del lavoratore è
pacifica e confermata dalla prassi INPS, ma non ho individuato su fonte primaria la
norma che fissa il riparto 23,81 / 9,19 del 33% complessivo del FPLD. È segnalato
anche nella nota del parametro dentro il file dei parametri.
